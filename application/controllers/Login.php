...
class Login extends CI_Controller {
	...
	Private function _sendmail($token='',$type=''){
		$config = [
               ...
               'charset'   => 'utf-8',
               'protocol'  => 'smtp',
               'smtp_host' => 'ssl://mail.kawaicase.com',
               'smtp_user' => 'admin@kawaicase.com',    // Ganti dengan email gmail kamu
               'smtp_pass' => 'vaefqedasfdhsd',      // Password gmail kamu
               'smtp_port' => 465,
               'crlf'      => "rn",
               'newline'   => "rn"
           ];
        ...
        $this->email->from('Tiketing');
        $this->email->to($this->input->post('email'));
        // $this->email->attach('https://masrud.com/content/images/20181215150137-codeigniter-smtp-gmail.png');
        if ($type == 'verify') {
        	$this->email->subject('Account verify Tiket Tiketing');
        	...
        	$this->email->subject('Akun Reset Tiket Tiketing');
