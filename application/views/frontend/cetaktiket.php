...
<body onload="window.print()">
  ...
  <div id="container">
    ...
    <div id="body">
        <ol type="1">
          <li>Tiketing * HANYA agen tiket bus. Ini tidak mengoperasikan layanan bus
            ...
            operator.
            Saran Tiketing kepada pelanggan adalah memilih operator bus yang mereka ketahui
          ...
          <li>Waktu keberangkatan yang disebutkan di tiket hanyalah waktu tentatif. Namun
           ...
           <li>Tanggung jawab Tiketing meliputi:
            ...
            alasannya, Tiketing akan mengembalikan jumlah diferensial kepada pelanggan setelah menjadi
        ...
        10,0%.</li>
        <li>Tanggung jawab Tiketing TIDAK termasuk:
        ...
        tulis rincian kupon tunai Anda ke support@Tiketing.in
