			...
			<div class="container">
				<div class="row fullscreen d-flex align-items-center justify-content-end">
					<div class="banner-content col-lg-7 col-md-12">
							<h2 class="text-white" >
						Tiketing dijamin resmi, pastikan Anda bisa pergi!				
							</h2>
						<p class="text-white" >
							Sekarang cari tiket bus semakin mudah, bisa pesan online di Tiketing. Tak perlu repot ke terminal atau kantor agen, sekarang Anda bisa beli tiket dengan mudah. Booking Cepat dan Mudah. Bebas Pilih Kursi. Termurah Setiap Hari. Customer Service 24/7. Semua Kelas dan Rute.
						</p>
			...
			<div class="container">
				<div class="row d-flex justify-content-center">
					<div class="col-md-8 pb-40 header-text">
						<h1>CARA PEMESANAN TIKET BUS</h1>
					</div>
				</div>
				<div class="row">
